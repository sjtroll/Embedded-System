...
# ONLY use relative file paths that start with $(SOURCELIB_ROOT)../
# DO NOT USE absolute file paths (e.g. /home/users/myuser/mydir)
LIBSRCS += $(MYLIB_PATH)/s4451119_sysmon.c
LIBSRCS += $(MYLIB_PATH)/s4451119_joystick.c
LIBSRCS += $(MYLIB_PATH)/s4451119_asccont.c
LIBSRCS += $(MYLIB_PATH)/s4451119_txradio.c
LIBSRCS += $(MYLIB_PATH)/s4451119_console.c
LIBSRCS += $(MYLIB_PATH)/s4451119_hamming.c
LIBSRCS += $(MYLIB_PATH)/s4451119_lta1000g.c
LIBSRCS += $(MYLIB_PATH)/s4451119_display.c